 ...
 *
 */
public class WordNetDesambiguisator 
{
    ...
    public static String SUBCLASSOF_RELATION = "subClassOf";
    public static String SUPERCLASSOF_RELATION = "superClassOf";	
    public static String PARTOF_RELATION = "partOf";
    public static String HASPART_RELATION = "hasPart";
    
    private static WordNetDesambiguisator instance;
    
    public static WordNetDesambiguisator getWordNetConnector() //pattern singleton
    {
        WordNetDesambiguisator r;
        if(instance == null)
        {
            r = new WordNetDesambiguisator();
            instance = r;
        }
        else
        {
	...
	public void init(){
                                        if(!isInit)
                                        {
                                            ...
                                            try {
                                                    ...
                                                    isInit = true;
                                                                                   // System.out.println("init ok : "+this.getRelation("chips","plant"));
    ...
    protected String getRelationName(PointerType pt) {
    	...
    	if (pt == PointerType.MEMBER_HOLONYM || pt == PointerType.PART_HOLONYM || pt == PointerType.SUBSTANCE_HOLONYM || pt == PointerType.REGION)
    		relation = HASPART_RELATION;
                   // System.out.println("Désambiuisation : "+relation);
    	return relation;
    }
...
protected String getTrivialSubsumption(String concept1, String concept2) {
    ...
    public String getRelation(String concept1, String concept2) {
                                        //System.out.println("lalal : "+concept1+" -- "+concept2);
		...
		return relation;
                    ...
                    public boolean isInWordNet(String term) 
                    {
                        int s = 0;
                        try{
                            s = wordnet.lookupAllIndexWords(term).size();
                        }
                        catch(Exception e)
                        {}
                    ...
                    public boolean isInDomain(String entityName)
                    {
                        return (this.getRelation(entityName, "Plant").equals("subClassOf"));
                    }
                      ...
                      {
                            try {
                                System.out.println(wordnet.lookupAllIndexWords("plant").size());
	...
	WordNetDesambiguisator wc = new WordNetDesambiguisator();
		wc.init();
                wc.testWordNet();
                //System.out.println(wc.getRelation("organism", "plant"));
